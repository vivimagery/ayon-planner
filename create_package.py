...
def copy_addon_package(
    ...
    """Copy addon package to output directory.

    Args:
        output_dir (str): Directory path to output addon package.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Skip frontend build and use existing dist folder."
            " Useful when frontend is already built."
        )
    )
    parser.add_argument(
        "--debug",
